...
extern const MIDL_SERVER_INFO IArrayDataTransport_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IArrayDataTransport_ProxyInfo;
...
/* 66 */	NdrFcShort( 0x2012 ),	/* Flags:  must free, out, srv alloc size=8 */
...
/* 1044 */	NdrFcShort( 0xff9e ),	/* Offset= -98 (946) */
/* 1046 */	
			0x11, 0xc,	/* FC_RP [alloced_on_stack] [simple_pointer] */
/* 1048 */	0x6,		/* FC_SHORT */
			0x5c,		/* FC_PAD */
...
/* Object interface: IArrayDataTransport, ver. 0.0,
   GUID={0x6AFC408E,0x42F4,0x4947,{0xAD,0x65,0x56,0x57,0x8E,0x30,0xDF,0xE8}} */

#pragma code_seg(".orpc")
static const unsigned short IArrayDataTransport_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IArrayDataTransport_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IArrayDataTransport_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IArrayDataTransport_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(10) _IArrayDataTransportProxyVtbl = 
{
    &IArrayDataTransport_ProxyInfo,
    &IID_IArrayDataTransport,
    ...
    (void *) (INT_PTR) -1 /* IArrayDataTransport::SafeArray */ ,
    (void *) (INT_PTR) -1 /* IArrayDataTransport::CStyle */ ,
    (void *) (INT_PTR) -1 /* IArrayDataTransport::NoArray */
};


static const PRPC_STUB_FUNCTION IArrayDataTransport_table[] =
{
...
CInterfaceStubVtbl _IArrayDataTransportStubVtbl =
{
    &IID_IArrayDataTransport,
    &IArrayDataTransport_ServerInfo,
    10,
    &IArrayDataTransport_table[-3],
...
const CInterfaceProxyVtbl * __InteropSafeArray_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IArrayDataTransportProxyVtbl,
    0
};

const CInterfaceStubVtbl * __InteropSafeArray_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IArrayDataTransportStubVtbl,
    0
};

PCInterfaceName const __InteropSafeArray_InterfaceNamesList[] = 
{
    "IArrayDataTransport",
    0
};

const IID *  __InteropSafeArray_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __InteropSafeArray_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __InteropSafeArray, pIID, n)

int __stdcall __InteropSafeArray_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__InteropSafeArray_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _InteropSafeArray_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __InteropSafeArray_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __InteropSafeArray_StubVtblList,
    (const PCInterfaceName * ) & __InteropSafeArray_InterfaceNamesList,
    (const IID ** ) & __InteropSafeArray_BaseIIDList,
    & __InteropSafeArray_IID_Lookup, 
    1,
    2,
