========================================================================
    ACTIVE TEMPLATE LIBRARY : InteropComTest Project Overview
========================================================================

AppWizard has created this InteropComTest project for you to use as the starting point for
...
_InteropComTest.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_InteropComTest.h)
        GUID definitions                                (_InteropComTest_i.c)
        A type library                                  (_InteropComTest.tlb)
        Marshaling code                                 (_InteropComTest_p.c and dlldata.c)
InteropComTest.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named InteropComTest.pch and a precompiled types file named StdAfx.obj.
...
InteropComTestps.vcproj
	...
	dlldata.c, InteropComTest_i.c and InteropComTest_p.c which are required
	to build the proxy/stub DLL.

InteropComTestps.def
    This module definition file provides the linker with information about the exports
